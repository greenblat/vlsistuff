...
void reserved_words(char *Token,char *tokenType){
    ...
    if (strcmp(Token,"endinterface")==0) {strcpy(tokenType,"endinterface"); return; }
    if (strcmp(Token,"endmodule")==0) {strcpy(tokenType,"endmodule"); return; }
    if (strcmp(Token,"endpackage")==0) {strcpy(tokenType,"endpackage"); return; }
    ...
    if (strcmp(Token,"import")==0) {strcpy(tokenType,"import"); return; }
    ...
    if (strcmp(Token,"interface")==0) {strcpy(tokenType,"interface"); return; }
    ...
    if (strcmp(Token,"modport")==0) {strcpy(tokenType,"modport"); return; }
...
void doubleNames(char *Token,char *tokenType){
    ...
    if (strcmp(Token,"++")==0) {strcpy(tokenType,"plusplus"); return; }
