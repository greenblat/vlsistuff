...
def monitorStuffs():
    ...
    counts += monitorStuff("tb.dut.merger1.axi_rd_4_merger.rdata_fifo.count")
    counts += monitorStuff("tb.dut.merger1.axi_rd_4_merger.rdata_fifo.int_count")
    ...
    counts += monitorStuff("tb.dut.merger1.axi_wr_4_merger.a_pri_count")
    counts += monitorStuff("tb.dut.merger1.axi_wr_4_merger.b_bcount")
    counts += monitorStuff("tb.dut.merger1.axi_wr_4_merger.b_pri_count")
    counts += monitorStuff("tb.dut.merger1.axi_wr_4_merger.c_bcount")
    counts += monitorStuff("tb.dut.merger1.axi_wr_4_merger.c_pri_count")
    counts += monitorStuff("tb.dut.merger1.axi_wr_4_merger.d_bcount")
    counts += monitorStuff("tb.dut.merger1.axi_wr_4_merger.d_pri_count")
    ...
    counts += monitorStuff("tb.dut.merger2.axi_rd_4_merger.rdata_fifo.count")
    counts += monitorStuff("tb.dut.merger2.axi_rd_4_merger.rdata_fifo.int_count")
    ...
    counts += monitorStuff("tb.dut.merger2.axi_wr_4_merger.a_pri_count")
    counts += monitorStuff("tb.dut.merger2.axi_wr_4_merger.b_bcount")
    counts += monitorStuff("tb.dut.merger2.axi_wr_4_merger.b_pri_count")
    counts += monitorStuff("tb.dut.merger2.axi_wr_4_merger.c_bcount")
    counts += monitorStuff("tb.dut.merger2.axi_wr_4_merger.c_pri_count")
    counts += monitorStuff("tb.dut.merger2.axi_wr_4_merger.d_bcount")
    counts += monitorStuff("tb.dut.merger2.axi_wr_4_merger.d_pri_count")
    ...
    counts += monitorStuff("tb.dut.merger3.axi_rd_4_merger.rdata_fifo.count")
    counts += monitorStuff("tb.dut.merger3.axi_rd_4_merger.rdata_fifo.int_count")
    ...
    counts += monitorStuff("tb.dut.merger3.axi_wr_4_merger.a_pri_count")
    counts += monitorStuff("tb.dut.merger3.axi_wr_4_merger.b_bcount")
    counts += monitorStuff("tb.dut.merger3.axi_wr_4_merger.b_pri_count")
    counts += monitorStuff("tb.dut.merger3.axi_wr_4_merger.c_bcount")
    counts += monitorStuff("tb.dut.merger3.axi_wr_4_merger.c_pri_count")
    counts += monitorStuff("tb.dut.merger3.axi_wr_4_merger.d_bcount")
    counts += monitorStuff("tb.dut.merger3.axi_wr_4_merger.d_pri_count")
    ...
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.a_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.a_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.ar_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.ar_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.b_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.b_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.c_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.c_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.d_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.d_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.r_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_rd_4_splitter.r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.a_bcount")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.b_bcount")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.c_bcount")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.d_bcount")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.aw_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.aw_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.b_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.b_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.back_bid_a_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.back_bid_a_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.back_bid_b_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.back_bid_b_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.back_bid_c_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.back_bid_c_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.back_bid_d_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.back_bid_d_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.order_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.order_fifo.count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.w_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter1.axi_wr_4_splitter.w_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.a_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.a_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.ar_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.ar_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.b_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.b_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.c_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.c_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.d_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.d_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.r_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_rd_4_splitter.r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.a_bcount")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.b_bcount")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.c_bcount")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.d_bcount")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.aw_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.aw_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.b_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.b_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.back_bid_a_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.back_bid_a_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.back_bid_b_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.back_bid_b_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.back_bid_c_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.back_bid_c_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.back_bid_d_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.back_bid_d_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.order_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.order_fifo.count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.w_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter2.axi_wr_4_splitter.w_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.a_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.a_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.ar_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.ar_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.b_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.b_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.c_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.c_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.d_r_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.d_r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.r_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_rd_4_splitter.r_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.a_bcount")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.b_bcount")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.c_bcount")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.d_bcount")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.aw_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.aw_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.b_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.b_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.back_bid_a_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.back_bid_a_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.back_bid_b_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.back_bid_b_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.back_bid_c_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.back_bid_c_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.back_bid_d_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.back_bid_d_fifo.int_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.order_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.order_fifo.count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.w_fifo.next_count")
    counts += monitorStuff("tb.dut.splitter3.axi_wr_4_splitter.w_fifo.count")
...
def snapshot():
    ...
    logs.log_info("SNP %x  tb.dut.merger1.axi_rd_4_merger.rdata_fifo.count" % logs.peek("tb.dut.merger1.axi_rd_4_merger.rdata_fifo.count"))
    logs.log_info("SNP %x  tb.dut.merger1.axi_rd_4_merger.rdata_fifo.int_count" % logs.peek("tb.dut.merger1.axi_rd_4_merger.rdata_fifo.int_count"))
    ...
    logs.log_info("SNP %x  tb.dut.merger1.axi_wr_4_merger.a_pri_count" % logs.peek("tb.dut.merger1.axi_wr_4_merger.a_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger1.axi_wr_4_merger.b_bcount" % logs.peek("tb.dut.merger1.axi_wr_4_merger.b_bcount"))
    logs.log_info("SNP %x  tb.dut.merger1.axi_wr_4_merger.b_pri_count" % logs.peek("tb.dut.merger1.axi_wr_4_merger.b_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger1.axi_wr_4_merger.c_bcount" % logs.peek("tb.dut.merger1.axi_wr_4_merger.c_bcount"))
    logs.log_info("SNP %x  tb.dut.merger1.axi_wr_4_merger.c_pri_count" % logs.peek("tb.dut.merger1.axi_wr_4_merger.c_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger1.axi_wr_4_merger.d_bcount" % logs.peek("tb.dut.merger1.axi_wr_4_merger.d_bcount"))
    logs.log_info("SNP %x  tb.dut.merger1.axi_wr_4_merger.d_pri_count" % logs.peek("tb.dut.merger1.axi_wr_4_merger.d_pri_count"))
    ...
    logs.log_info("SNP %x  tb.dut.merger2.axi_rd_4_merger.rdata_fifo.count" % logs.peek("tb.dut.merger2.axi_rd_4_merger.rdata_fifo.count"))
    logs.log_info("SNP %x  tb.dut.merger2.axi_rd_4_merger.rdata_fifo.int_count" % logs.peek("tb.dut.merger2.axi_rd_4_merger.rdata_fifo.int_count"))
    ...
    logs.log_info("SNP %x  tb.dut.merger2.axi_wr_4_merger.a_pri_count" % logs.peek("tb.dut.merger2.axi_wr_4_merger.a_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger2.axi_wr_4_merger.b_bcount" % logs.peek("tb.dut.merger2.axi_wr_4_merger.b_bcount"))
    logs.log_info("SNP %x  tb.dut.merger2.axi_wr_4_merger.b_pri_count" % logs.peek("tb.dut.merger2.axi_wr_4_merger.b_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger2.axi_wr_4_merger.c_bcount" % logs.peek("tb.dut.merger2.axi_wr_4_merger.c_bcount"))
    logs.log_info("SNP %x  tb.dut.merger2.axi_wr_4_merger.c_pri_count" % logs.peek("tb.dut.merger2.axi_wr_4_merger.c_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger2.axi_wr_4_merger.d_bcount" % logs.peek("tb.dut.merger2.axi_wr_4_merger.d_bcount"))
    logs.log_info("SNP %x  tb.dut.merger2.axi_wr_4_merger.d_pri_count" % logs.peek("tb.dut.merger2.axi_wr_4_merger.d_pri_count"))
    ...
    logs.log_info("SNP %x  tb.dut.merger3.axi_rd_4_merger.rdata_fifo.count" % logs.peek("tb.dut.merger3.axi_rd_4_merger.rdata_fifo.count"))
    logs.log_info("SNP %x  tb.dut.merger3.axi_rd_4_merger.rdata_fifo.int_count" % logs.peek("tb.dut.merger3.axi_rd_4_merger.rdata_fifo.int_count"))
    ...
    logs.log_info("SNP %x  tb.dut.merger3.axi_wr_4_merger.a_pri_count" % logs.peek("tb.dut.merger3.axi_wr_4_merger.a_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger3.axi_wr_4_merger.b_bcount" % logs.peek("tb.dut.merger3.axi_wr_4_merger.b_bcount"))
    logs.log_info("SNP %x  tb.dut.merger3.axi_wr_4_merger.b_pri_count" % logs.peek("tb.dut.merger3.axi_wr_4_merger.b_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger3.axi_wr_4_merger.c_bcount" % logs.peek("tb.dut.merger3.axi_wr_4_merger.c_bcount"))
    logs.log_info("SNP %x  tb.dut.merger3.axi_wr_4_merger.c_pri_count" % logs.peek("tb.dut.merger3.axi_wr_4_merger.c_pri_count"))
    logs.log_info("SNP %x  tb.dut.merger3.axi_wr_4_merger.d_bcount" % logs.peek("tb.dut.merger3.axi_wr_4_merger.d_bcount"))
    logs.log_info("SNP %x  tb.dut.merger3.axi_wr_4_merger.d_pri_count" % logs.peek("tb.dut.merger3.axi_wr_4_merger.d_pri_count"))
    ...
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.a_r_fifo.count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.a_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.a_r_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.a_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.ar_fifo.next_count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.ar_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.ar_fifo.count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.ar_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.b_r_fifo.count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.b_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.b_r_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.b_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.c_r_fifo.count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.c_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.c_r_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.c_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.d_r_fifo.count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.d_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.d_r_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.d_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.r_fifo.count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_rd_4_splitter.r_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_rd_4_splitter.r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.a_bcount" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.a_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.b_bcount" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.b_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.c_bcount" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.c_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.d_bcount" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.d_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.aw_fifo.next_count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.aw_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.aw_fifo.count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.aw_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.b_fifo.next_count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.b_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.b_fifo.count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.b_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.back_bid_a_fifo.count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.back_bid_a_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.back_bid_a_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.back_bid_a_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.back_bid_b_fifo.count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.back_bid_b_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.back_bid_b_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.back_bid_b_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.back_bid_c_fifo.count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.back_bid_c_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.back_bid_c_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.back_bid_c_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.back_bid_d_fifo.count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.back_bid_d_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.back_bid_d_fifo.int_count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.back_bid_d_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.order_fifo.next_count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.order_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.order_fifo.count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.order_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.w_fifo.next_count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.w_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter1.axi_wr_4_splitter.w_fifo.count" % logs.peek("tb.dut.splitter1.axi_wr_4_splitter.w_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.a_r_fifo.count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.a_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.a_r_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.a_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.ar_fifo.next_count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.ar_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.ar_fifo.count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.ar_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.b_r_fifo.count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.b_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.b_r_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.b_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.c_r_fifo.count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.c_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.c_r_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.c_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.d_r_fifo.count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.d_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.d_r_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.d_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.r_fifo.count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_rd_4_splitter.r_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_rd_4_splitter.r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.a_bcount" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.a_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.b_bcount" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.b_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.c_bcount" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.c_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.d_bcount" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.d_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.aw_fifo.next_count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.aw_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.aw_fifo.count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.aw_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.b_fifo.next_count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.b_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.b_fifo.count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.b_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.back_bid_a_fifo.count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.back_bid_a_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.back_bid_a_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.back_bid_a_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.back_bid_b_fifo.count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.back_bid_b_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.back_bid_b_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.back_bid_b_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.back_bid_c_fifo.count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.back_bid_c_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.back_bid_c_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.back_bid_c_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.back_bid_d_fifo.count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.back_bid_d_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.back_bid_d_fifo.int_count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.back_bid_d_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.order_fifo.next_count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.order_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.order_fifo.count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.order_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.w_fifo.next_count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.w_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter2.axi_wr_4_splitter.w_fifo.count" % logs.peek("tb.dut.splitter2.axi_wr_4_splitter.w_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.a_r_fifo.count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.a_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.a_r_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.a_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.ar_fifo.next_count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.ar_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.ar_fifo.count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.ar_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.b_r_fifo.count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.b_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.b_r_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.b_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.c_r_fifo.count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.c_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.c_r_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.c_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.d_r_fifo.count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.d_r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.d_r_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.d_r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.r_fifo.count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.r_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_rd_4_splitter.r_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_rd_4_splitter.r_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.a_bcount" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.a_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.b_bcount" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.b_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.c_bcount" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.c_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.d_bcount" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.d_bcount"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.aw_fifo.next_count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.aw_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.aw_fifo.count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.aw_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.b_fifo.next_count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.b_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.b_fifo.count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.b_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.back_bid_a_fifo.count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.back_bid_a_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.back_bid_a_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.back_bid_a_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.back_bid_b_fifo.count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.back_bid_b_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.back_bid_b_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.back_bid_b_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.back_bid_c_fifo.count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.back_bid_c_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.back_bid_c_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.back_bid_c_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.back_bid_d_fifo.count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.back_bid_d_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.back_bid_d_fifo.int_count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.back_bid_d_fifo.int_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.order_fifo.next_count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.order_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.order_fifo.count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.order_fifo.count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.w_fifo.next_count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.w_fifo.next_count"))
    logs.log_info("SNP %x  tb.dut.splitter3.axi_wr_4_splitter.w_fifo.count" % logs.peek("tb.dut.splitter3.axi_wr_4_splitter.w_fifo.count"))
