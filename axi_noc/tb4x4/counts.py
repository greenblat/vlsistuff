...
def monitorStuffs():
    ...
    counts += monitorStuff("tb.dut.merger0.axi_wr_4_merger.work_aw_fifo.count")
    counts += monitorStuff("tb.dut.merger0.axi_wr_4_merger.work_aw_fifo.int_count")
...
def snapshot():
    ...
    logs.log_info("SNP %x  tb.dut.merger0.axi_wr_4_merger.work_aw_fifo.count" % logs.peek("tb.dut.merger0.axi_wr_4_merger.work_aw_fifo.count"))
    logs.log_info("SNP %x  tb.dut.merger0.axi_wr_4_merger.work_aw_fifo.int_count" % logs.peek("tb.dut.merger0.axi_wr_4_merger.work_aw_fifo.int_count"))
