...
//    PyRun_SimpleString("import string,os,sys\n");
//    PyRun_SimpleString("sys.path=sys.path+['./']\n");
//    sprintf(option,"from %s import *\n","verilog");
//    PyRun_SimpleString(option);
//    PyRun_SimpleString("import veri\n");
//    PyRun_SimpleString("print 'available veri. services: ',dir(veri)\n");
