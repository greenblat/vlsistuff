...
#define st_double 10
#define st_either 11
#define st_either1 12
#define st_eqeq2 13
#define st_eqeq3 14
#define st_floating 15
#define st_floating0 16
#define st_hex1 17
#define st_hex2 18
#define st_idle 19
#define st_neq2 20
...
#define st_new 22
#define st_newver 23
#define st_newver3 24
#define st_number 25
#define st_power 26
#define st_pragma1 27
#define st_pragma2 28
#define st_shift0 29
#define st_shift1 30
#define st_sizednumber 31
#define st_string 32
#define st_token 33
#define st_ubin1 34
#define st_ubin2 35
...
char strx11[]="qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM0123456789_.$";
char strx12[]="0123456789";
char strx13[]=".";
char strx14[]="'";
char strx15[]="b";
char strx16[]="h";
...
char strx19[]="{";
char strx20[]="01_xzXZ?";
char strx21[]="0123456789abcdefABCDEF_zZxX";
char strx22[]="_";
char strx23[]="(";
char strx24[]=")";
char strx25[]=":";
...
//    printf("state=%d char=|%c| next=|%c|\n",State,Char,Next);
    ...
    case st_bin1: {
        ...
        if (in_string(Char,strx15)&&in_string(Next,strx20)) {
              action("add","0",Char);
              State=st_bin2;
              return;
        }
    ...
    case st_dig0: {
        if (in_string(Char,strx18)&&in_string(Next,strx17)) {
              action("add","0",Char);
              State=st_dig1;
              return;
        }
    ...
    case st_dig1: {
        if (in_string(Char,strx17)&&in_string(Next,strx12)) {
              action("add","0",Char);
              State=st_dig2;
              return;
        }
        if (in_string(Char,strx17)&&in_string(Next,strx4)) {
              action("add","0",Char);
              State=st_dig2;
              return;
        }
    ...
    case st_dig2: {
        if (in_string(Char,strx12)&&in_string(Next,strx12)) {
              action("add","0",Char);
              State=st_dig2;
              return;
        }
        if (in_string(Char,strx12)&&in_string(Next,strx22)) {
              action("add","0",Char);
              State=st_dig2;
              return;
        }
    ...
    case st_either: {
        if (in_string(Char,strx6)&&in_string(Next,strx24)) {
              action("add","0",Char);
              State=st_either1;
              return;
        }
    ...
    case st_floating0: {
        if (in_string(Char,strx13)&&in_string(Next,strx12)) {
              action("add","0",Char);
              State=st_floating;
              return;
        }
    ...
    case st_hex2: {
        if (in_string(Char,strx21)&&in_string(Next,strx21)) {
              action("add","0",Char);
              State=st_hex2;
              return;
        }
    ...
    case st_idle: {
        ...
        if (in_string(Char,strx14)&&in_string(Next,strx16)) {
              action("add","0",Char);
              State=st_uhex1;
              return;
        }
        if (in_string(Char,strx14)&&in_string(Next,strx17)) {
              action("add","0",Char);
              State=st_udig1;
              return;
        }
        ...
        if (in_string(Char,strx14)&&in_string(Next,strx19)) {
              action("none","0",Char);
              State=st_idle;
              return;
        }
        if (in_string(Char,strx23)&&in_string(Next,strx6)) {
              action("add","0",Char);
              State=st_either;
              return;
        }
        ...
        if (in_string(Char,strx27)&&in_string(Next,strx25)) {
              action("add","0",Char);
              State=st_new;
              return;
        }
        ...
        if (in_string(Char,strx29)&&in_string(Next,strx28)) {
              action("add","0",Char);
              State=st_neq2;
              return;
        }
        ...
        if (in_string(Char,strx31)&&in_string(Next,strx31)) {
              action("add","0",Char);
              State=st_shift0;
              return;
        }
        ...
        if (in_string(Char,strx33)&&in_string(Next,strx34)) {
              action("add","0",Char);
              State=st_double;
              return;
        }
        ...
        if (in_string(Char,strx35)&&in_string(Next,strx1)) {
              action("add","0",Char);
              State=st_string;
              return;
        }
        if (in_string(Char,strx36)&&in_string(Next,strx1)) {
    ...
    case st_newver: {
        ...
        if (in_string(Char,strx32)&&in_string(Next,strx32)) {
              action("add","0",Char);
              State=st_newver;
              return;
        }
    ...
    case st_udig2: {
        if (in_string(Char,strx4)&&in_string(Next,strx12)) {
              action("add","0",Char);
              State=st_udig2;
              return;
        }
    ...
    case st_uhex2: {
        if (in_string(Char,strx4)&&in_string(Next,strx21)) {
              action("add","0",Char);
              State=st_uhex2;
              return;
        }
