...
#        print 'list<><>',Item
        for X in Item[1:]:
#            functiontorun(Current,X,Params,Stack)
...
#            print '<><<<>',Item,Mod.localparams[Item],compute1(Mod.localparams[Item],Mod)
