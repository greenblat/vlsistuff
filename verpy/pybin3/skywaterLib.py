...
Desc.add_pin_func("QN","IQN")
Desc.set_pin_job("CLK","clock")
Desc.set_pin_job("DE","data_enable")
Desc.set_pin_job("D","data")
Desc.add_pin("CLK","input")
Desc.add_pin("D","input")
...
cellLib["scs130ms_dfbbn_1"].set_pin_job("D","data")
cellLib["scs130ms_dfbbp_1"].set_pin_job("D","data")
cellLib["scs130ms_dfrbp_1"].set_pin_job("D","data")
cellLib["scs130ms_dfrtn_1"].set_pin_job("D","data")
cellLib["scs130ms_dfsbp_1"].set_pin_job("D","data")
cellLib["scs130ms_dfstp_1"].set_pin_job("D","data")
cellLib["scs130ms_dfxbp_1"].set_pin_job("D","data")
cellLib["scs130ms_dfxtp_1"].set_pin_job("D","data")
cellLib["scs130ms_edfxtp_1"].set_pin_job("D","data")
cellLib["scs130ms_edfxtp_1"].set_pin_job("DE","data")
cellLib["scs130ms_sdfbbn_1"].set_pin_job("D","data")
cellLib["scs130ms_sdfbbp_1"].set_pin_job("D","data")
cellLib["scs130ms_sdfrbp_1"].set_pin_job("D","data")
cellLib["scs130ms_sdfrtn_1"].set_pin_job("D","data")
cellLib["scs130ms_sdfrtp_1"].set_pin_job("D","data")
cellLib["scs130ms_sdfsbp_1"].set_pin_job("D","data")
cellLib["scs130ms_sdfstp_1"].set_pin_job("D","data")
cellLib["scs130ms_sdfxbp_1"].set_pin_job("D","data")
cellLib["scs130ms_sdfxtp_1"].set_pin_job("D","data")
cellLib["scs130ms_sedfxbp_1"].set_pin_job("D","data")
cellLib["scs130ms_sedfxbp_1"].set_pin_job("DE","data")
cellLib["scs130ms_sedfxtp_1"].set_pin_job("D","data")
cellLib["scs130ms_sedfxtp_1"].set_pin_job("DE","data")
